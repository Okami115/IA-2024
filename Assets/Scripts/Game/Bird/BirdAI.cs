...
public class BirdAI : BirdBase
{
    protected override void OnThink(float dt, BirdBehaviour birdBehaviour, Obstacle obstacle, Coin coin)
    {
        ...
        inputs[2] = (coin.transform.position - birdBehaviour.transform.position).y / 10.0f;
        ...
        genome.fitness += (90.0f - Vector3.Distance(coin.transform.position, birdBehaviour.transform.position));
    }
