...
namespace BrainSystem.System
{
    public class BrainSystem : ECSSystem
    {
        ...
        private float NeuronSynapsis(uint entity, int neuron, float[] inputs, int layer)
        {
            ...
            a += biasComponents[entity].X * hiddenLayerComponents[entity].hiddenLayers[layer].weights[neuron, exclusive - 1];
        ...
        private float LastNeuronSynapsis(uint entity, int neuron, float[] inputs)
        {
            ...
            a += biasComponents[entity].X * outputsLayerComponents[entity].layer.weights[neuron, exclusive - 1];
        ...
        private float FirstNeuronSynapsis(uint entity, int neuron, float[] inputs)
        {
            ...
            a += biasComponents[entity].X * inputLayerComponents[entity].layer.weights[neuron, inputs.Length - 1];
